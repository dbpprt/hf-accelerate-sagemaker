...
def main(params):
    ...
    lr_scheduler = get_linear_schedule_with_warmup(
        optimizer=optimizer,
        num_warmup_steps=0.06 * (len(train_dataloader) * params.num_epochs),
    ...
    for epoch in range(starting_epoch, params.num_epochs):
        model.train()
        total_loss = 0
...
def parse_args():
    ...
    parser.add_argument(
        "--num-epochs", default=30, type=int, metavar="N", help="number of total epochs to run"
    )
